...
class genTexts:
    ...
    latent_dim = 512
    num_samples = 10000
    data_path = 'textParsing/data/exp1.txt'
    model_path = 'textParsing/models/exp1.h5'
    ...
    def read_data(self):
        ...
        for line in lines[: min(self.num_samples, len(lines) - 1)]:
            ...
            input_text = self.delSign(previosText[4:])
            target_text = '\t' + line[4:] + '\n'
    ...
    def setCapitalLetters(self, text):
        endLetters = set('.?!')
        isNewSentence = True
        result = ''

        for char in text:
            if char in endLetters:
                isNewSentence = True
    ...
    def get(self, s):
        ...
        return self.setCapitalLetters(decoded_sentence)
